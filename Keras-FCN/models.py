...
def zerg_model_2(weight_decay=0., batch_momentum=0.9, batch_shape=[20, 320, 320, 3], classes=2):
    if batch_shape:
        img_input = Input(batch_shape=batch_shape)
        image_size = batch_shape[1:3]
    else:
    ...
    x = identity_block(3, [256, 256, 1024], stage=4, block='i', weight_decay=weight_decay, batch_momentum=batch_momentum)(x)
